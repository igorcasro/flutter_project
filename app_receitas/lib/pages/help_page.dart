...
class HelpPage extends StatelessWidget {
  ...
  final _helptext = "A primeira coisa que você deve fazer ao entrar no Fridgey é adicionar novos ingredientes à sua geladeira. Abra a geladeira (ou o armário) e vá adicionando os ovos, as batatas, o leite... o que você tiver na geladeira! Em seguida, vá para a página de Achar Receitas, escolha uma delas e siga o modo de preparo!";
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: 50, top: 500),
              child:
                Image.asset(
