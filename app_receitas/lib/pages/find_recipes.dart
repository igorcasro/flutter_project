          ...
          Row(
            children: [
              ...
              Container(
                  ...
                  width: 60,
                  child: Image.asset('assets/images/icons/search_2.png')),
            ],
          )
        ],
      ),
      ...
      Container(
          ...
          decoration: BoxDecoration(
              image: const DecorationImage(
                  image: AssetImage('assets/images/receitas/pure.jpg'),
                  fit: BoxFit.fitWidth),
              borderRadius: BorderRadius.circular(15)),
          child: InkWell(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:
          Visibility(visible: !keyboardIsOpen, child: _centerBottomBar()),
